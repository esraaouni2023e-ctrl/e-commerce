        ...
        <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            <label class="form-label" for="product-description-input">Product Description</label>
                            <textarea class="form-control" id="product-description-input" name="description"
                            ...
                            <div class="text-center">
                                <div class="position-relative d-inline-block">
                                    <div class="position-absolute top-100 start-100 translate-middle">
                                        ...
                                        <input class="form-control d-none" id="product-image-input" name="main_image"
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="manufacturer-name-input"
                                                   name="manufacturer_name" placeholder="Enter manufacturer name" required>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="manufacturer-brand-input"
                                                   name="manufacturer_brand" placeholder="Enter manufacturer brand" required>
                                            <div class="invalid-feedback">Please enter manufacturer brand.</div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-3 col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" id="stocks-input" name="stock"
                                                   placeholder="Stocks" required>
                                            <div class="invalid-feedback">Please Enter product stock.</div>
                                        </div>
                                    </div>
                                    <div class="col-lg-3 col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group has-validation mb-3">
                                                ...
                                                <input type="number" step="0.01" class="form-control" id="product-price-input"
                                    ...
                                    <div class="col-lg-3 col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="number" step="0.1" class="form-control" id="product-discount-input"
                                    ...
                                    <div class="col-lg-3 col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" id="orders-input" name="orders"
                                                   placeholder="Orders" value="0" readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="tab-pane" id="addproduct-metadata" role="tabpanel">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="meta-description-input" name="meta_description"
                                              rows="3" placeholder="Enter meta description"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
...
<!-- JavaScript pour prévisualiser l'image principale -->
<script>
    document.getElementById('product-image-input').onchange = function (e) {
