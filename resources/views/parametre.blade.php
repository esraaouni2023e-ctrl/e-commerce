...
<body>
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown topbar-head-dropdown ms-1 header-item">
                    ...
                    <div class="dropdown-menu dropdown-menu-xl dropdown-menu-end p-0 dropdown-menu-cart" aria-labelledby="page-header-cart-dropdown">
                        ...
                        <div class="p-3 border-bottom-0 border-start-0 border-end-0 border-dashed border" id="parametre-elem">
                            ...
                            <a href="apps-ecommerce-parametre.html" class="btn btn-success text-center w-100">
                                Checkout
                            </a>
                        </div>
                    </div>
    ...
    <a href="{{ route('modiprofil') }}" class="d-flex align-items-center text-decoration-none">
        <img class="rounded-circle header-profile-user"
             src="{{ asset('C:\laragon\www\stage\public\00.png') }}"
             alt="Header Avatar"
             height="32">

        <span class="d-none d-xl-inline-block ms-2 fw-medium user-name-text">
                      @auth
    {{ Auth::user()->name }}
@endauth
        </span>
...
<div id="removeNotificationModal" class="modal fade zoomIn" tabindex="-1" aria-hidden="true">
            ...
            <div id="scrollbar">
                <div class="container-fluid">
                  ...
                  <ul class="navbar-nav" id="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link menu-link flex items-center space-x-2 text-[var(--text-primary)] font-medium sidebar-link bg-[var(--accent)]/10" href="#sidebarProfile" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarProfile">
                        ...
                        <div class="collapse menu-dropdown" id="sidebarProfile">
                            <ul class="nav nav-sm flex-column pl-6">
                                <li class="nav-item">
                                    <a href="{{ route('welcome-client') }}" class="nav-link text-[var(--text-secondary)] py-2 ">Page Profil</a>
                                </li>
                                <li class="nav-item">
                                    <a href="pages-profile-settings.html" class="nav-link text-[var(--text-secondary)] py-2">Paramètres</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    ...
                    <!-- Boutique -->
                    <li class="nav-item">
                        <a class="nav-link menu-link flex items-center space-x-2 text-[var(--text-primary)] font-medium sidebar-link" href="#sidebarEcommerce" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarEcommerce">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="collapse menu-dropdown" id="sidebarEcommerce">
                            <ul class="nav nav-sm flex-column pl-6">
                                <li class="nav-item">
                                    <a href="apps-ecommerce-products.html" class="nav-link text-[var(--text-secondary)] py-2">Produits</a>
                                </li>


                                <li class="nav-item">
                                    <a href= "{{ route('order') }}" class="nav-link text-[var(--text-secondary)] py-2">Commandes</a>
                                </li>


                                <li class="nav-item">
                                    <a href="apps-ecommerce-parametre.html" class="nav-link text-[var(--text-secondary)] py-2">Paiement</a>
                                </li>
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-xl-8">
                            <div class="card">
                                <div class="card-body parametre-tab">
    ...
    <!-- init js -->
    <script src="assets/js/pages/ecommerce-product-parametre.init.js"></script>
