                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse menu-dropdown" id="sidebarProfile">
                            <ul class="nav nav-sm flex-column pl-6">
                              <li class="nav-item">
                                    <a href="{{ route('welcome-boutique') }}" class="nav-link text-[var(--text-secondary)] py-2 ">Page Profil</a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('parametre') }}" class="nav-link text-[var(--text-secondary)] py-2">Paramètres</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse menu-dropdown" id="sidebarEcommerce">
                            <ul class="nav nav-sm flex-column pl-6">
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('addproduct') }}" class="nav-link text-[var(--text-secondary)] py-2">Ajouter Produit</a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('order') }}" class="nav-link text-[var(--text-secondary)] py-2">Commandes</a>
                                </li>
                                <li class="nav-item">
                                    <a href= "{{ route('detorder') }}" class="nav-link text-[var(--text-secondary)] py-2">Détails Commande</a>
                                </li>


                                <li class="nav-item">
                                    <a href="{{ route('sellers') }}" class="nav-link text-[var(--text-secondary)] py-2">Vendeurs</a>
                                </li>
                                <li class="nav-item">
                                    <a href="apps-ecommerce-seller-details.html" class="nav-link text-[var(--text-secondary)] py-2">Détails Vendeur</a>
                                </li>
                            </ul>
                        </div>
                    </li>
